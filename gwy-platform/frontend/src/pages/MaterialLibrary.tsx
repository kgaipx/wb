...
const MATERIALS: Material[] = [
  ...
  { id: "q13", cat: "quote", title: "法者，天下之程式也，万事之仪表也。", sub: "《管子·明法》", tags: ["法治", "治理"], usage: "依法治国、法治政府建设的分论点引子。" },
  { id: "q14", cat: "quote", title: "人而无信，不知其可也。", sub: "《论语·为政》", tags: ["诚信", "道德"], usage: "社会信用体系、诚信营商环境主题。" },
  { id: "q15", cat: "quote", title: "周虽旧邦，其命维新。", sub: "《诗经·大雅·文王》", tags: ["创新", "改革"], usage: "改革创新、守正创新、自我革命。" },
  { id: "q16", cat: "quote", title: "致天下之治者在人才，成天下之才者在教化。", sub: "胡瑗《松滋县学记》", tags: ["人才", "教育"], usage: "人才强国、教育科技人才一体化。" },
  { id: "q17", cat: "quote", title: "取之有度，用之有节，则常足。", sub: "《资治通鉴》", tags: ["生态", "可持续"], usage: "资源节约、可持续发展、绿色生活。" },
  { id: "q18", cat: "quote", title: "些小吾曹州县吏，一枝一叶总关情。", sub: "郑板桥《潍县署中画竹呈年伯包大中丞括》", tags: ["民生", "基层"], usage: "基层情怀、群众冷暖、为民办实事。" },
  { id: "q19", cat: "quote", title: "空谈误国，实干兴邦。", sub: "治国理政箴言", tags: ["实干", "担当"], usage: "抓落实、实干导向、作风建设的立论句。" },
  { id: "q20", cat: "quote", title: "先天下之忧而忧，后天下之乐而乐。", sub: "范仲淹《岳阳楼记》", tags: ["担当", "奉献"], usage: "公仆情怀、担当作为、价值追求。" },
  ...
  { id: "p11", cat: "policy", title: "枫桥经验", sub: "发动和依靠群众，坚持矛盾不上交、就地化解的基层治理经验。", tags: ["治理", "基层"], usage: "基层治理创新、矛盾纠纷多元化解。" },
  { id: "p12", cat: "policy", title: "四下基层", sub: "宣传党的路线方针政策下基层、调查研究下基层、信访接待下基层、现场办公下基层。", tags: ["作风", "基层"], usage: "干部作风建设、走好新时代群众路线。" },
  { id: "p13", cat: "policy", title: "一流营商环境", sub: "市场化、法治化、国际化的一流营商环境，让各类经营主体放心投资、安心经营。", tags: ["经济", "治理"], usage: "放管服改革、市场主体活力、对外开放。" },
  { id: "p14", cat: "policy", title: "文化数字化战略", sub: "以数字化赋能文化生产、传播与消费，建设国家文化大数据体系。", tags: ["文化", "数字"], usage: "文旅融合、文化传承创新、数字文化产业。" },
  { id: "p15", cat: "policy", title: "城市更新行动", sub: "以存量提质改造为主，补齐基础设施与公共服务短板，让城市更有温度。", tags: ["城市", "民生"], usage: "老旧小区改造、韧性城市、城市治理。" },
  { id: "p16", cat: "policy", title: "技能型社会", sub: "营造劳动光荣、技能宝贵的社会风尚，培养高素质技术技能人才。", tags: ["人才", "就业"], usage: "大国工匠、职业教育、稳就业保民生。" },
  ...
  { id: "t11", cat: "topic", title: "营商环境优化", sub: "以改革之力破制度藩篱，让企业办事更顺、成本更低、预期更稳。", body: "论证角度：① 简政放权提效能；② 法治保障稳预期；③ 亲清政商关系优生态。", tags: ["经济", "治理"], usage: "市场主体、对外开放、高质量发展题。" },
  { id: "t12", cat: "topic", title: "技能人才与大国工匠", sub: "以匠心铸就品质，让技能人才有舞台、有奔头、有尊严。", body: "论证角度：① 产教融合育新人；② 评价激励活机制；③ 工匠精神代代传。", tags: ["人才", "就业"], usage: "制造强国、职业教育、就业质量主题。" },
  { id: "t13", cat: "topic", title: "县域经济与城乡融合", sub: "县域一头连着城市、一头连着乡村，是城乡融合发展的关键枢纽。", body: "论证角度：① 特色产业强县域；② 基础设施补短板；③ 公共服务均等化。", tags: ["经济", "乡村"], usage: "新型城镇化、乡村振兴、区域协调。" },
  { id: "t14", cat: "topic", title: "一老一小", sub: "老有所养、幼有所育，是最朴素的民生期待，也是社会治理的绣花功夫。", body: "论证角度：① 普惠托育补缺口；② 居家社区养老为主；③ 政策协同与多元参与。", tags: ["养老", "民生"], usage: "人口高质量发展、社会保障体系题。" },
  { id: "t15", cat: "topic", title: "国货潮品与文化消费", sub: "文化自信托举国货崛起，消费升级反哺文化创新，实现双向奔赴。", body: "论证角度：① 品质与创新立身；② 传统文化IP赋能；③ 消费环境与版权保护。", tags: ["文化", "消费"], usage: "内需扩容、文化强国、品牌建设题。" },
  { id: "t16", cat: "topic", title: "韧性城市与防灾减灾", sub: "把风险防范挺在前面，让城市在极端情况下仍能正常运转。", body: "论证角度：① 基础设施强韧性；② 应急体系补短板；③ 公众素养同提升。", tags: ["安全", "城市"], usage: "公共安全、极端天气应对、城市治理。" },
  ...
  { id: "m9", cat: "template", title: "数据论证段", body: "数据显示，____（数字变化）。数字背后，是____（实质）。可见，____（回扣观点）。", usage: "用权威数据增强论证刚性，避免空谈。" },
  { id: "m10", cat: "template", title: "对比论证段", body: "反观____（另一做法/地区），____（问题与后果）。两相对照，更加凸显____（必要性）。", usage: "正反对比凸显主题价值，增强说服力。" },
  { id: "m11", cat: "template", title: "意义升华段", body: "此举不仅____（当下之效），更将____（长远之利），于____、于____均大有裨益。", usage: "多主体、多维度阐述举措意义。" },
  { id: "m12", cat: "template", title: "总起·关系式", body: "____，一头连着____（一方），一头连着____（另一方）。做好____这篇大文章，关键在____。", usage: "统领全文的总起段，快速亮明议题与切入点。" },
];
